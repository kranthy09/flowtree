...
- **List Nodes:** All nodes _for this workspace_ render as a vertical list (table/cards) AND as a Mermaid diagram simultaneously. Both views stay in sync.
...
**Adds:** Columns for what each node _does_.
